...
app.get('/random-quote-en', (req, res) => {
    const query = 'SELECT * FROM quotes ORDER BY RANDOM() LIMIT 1'; // 영어 명언 테이블에서 랜덤으로 가져오기
...
app.get('/random-quote-ko', (req, res) => {
    const query = 'SELECT * FROM quotes ORDER BY RANDOM() LIMIT 1'; // 한국어 명언 테이블에서 랜덤으로 가져오기
    console.log('Executing query:', query);
